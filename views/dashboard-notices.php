...
<div class="notice notice-success is-dismissible <?php echo $this->plugin->name; ?>-notice-welcome">
	<p>Thank you for installing <?php echo $this->plugin->displayName; ?>! The plugin has been installed under Settings. <a href="<?php echo $setting_page; ?>">Click here</a> to configure the plugin.</p>
</div>
